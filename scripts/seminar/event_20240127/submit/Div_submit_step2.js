				...
				<div class="flex flex-col justify-center items-center px-4 mx-auto w-full space-y-4" id="div_submit_btn_list">
					<div class="flex flex-row w-full justify-center items-center space-x-4">
						<button type="button" id="btn_submit_check" class={class_btn_payment} 
								onClick={() => request_order_id(uuid_product_id, "00422de9-bd2b-46ea-91ca-19268a03b375", "card", txt_email, txt_name)}>
							카드 결제
						</button>
						<button type="button" id="btn_submit_check" class={class_btn_payment}
								onClick={() => request_order_id(uuid_product_id, "00422de9-bd2b-46ea-91ca-19268a03b375", "va", txt_email, txt_name)}>
							무통장 입금
						</button>
						<button type="button" id="btn_submit_check" class={class_btn_payment}
								onClick={() => request_order_id(uuid_product_id, "00422de9-bd2b-46ea-91ca-19268a03b375", "account", txt_email, txt_name)}>
							계좌 이체
						</button>
