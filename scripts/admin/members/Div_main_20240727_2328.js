				...
				<div class="w-full bg-white border border-gray-200 rounded-lg shadow">
					<div class="p-4 bg-white rounded-lg md:p-8 text-center">
						...
						<dl class="grid grid-cols-4 w-full md:grid-cols-2 gap-8 p-4 mx-auto text-gray-900 md:p-8">
							<Div_sub_card title={"총 가입자 수"} value={props.data.count_joined.val_member_total['0']} unit={"명"} />
							<Div_sub_card title={"올해 가입자 수"} value={props.data.count_joined.val_member_yearly['0']} unit={"명"}
										  subtitle={"작년"} subvalue={props.data.count_joined.val_member_yearly_last['0']} />
							<Div_sub_card title={"이번 달 가입자 수"} value={props.data.count_joined.val_member_monthly['0']} unit={"명"}
										  subtitle={"지난 달"} subvalue={props.data.count_joined.val_member_monthly_last['0']} />
							<Div_sub_card title={"오늘 가입자 수"} value={props.data.count_joined.val_member_daily['0']} unit={"명"}
										  subtitle={"어제"} subvalue={props.data.count_joined.val_member_daily_last['0']} />
						</dl>
					</div>
				</div>
