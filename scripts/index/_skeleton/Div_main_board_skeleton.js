		...
		<div class="flex flex-row pt-12 pb-12 justify-center" id="div_board">
			<div class="container mx-auto">
				<div class="grid grid-cols-3 md:grid-cols-1 mx-auto">
					<Div_board_loading title={"자유게시판"} />
					<Div_board_loading title={"가입인사/방명록"} />
					<Div_board_loading title={"공지사항"} />
					<Div_board_loading title={"유튜브 강의 게시판"} />
					<Div_board_loading title={"워크샵 게시판"} />
					<Div_board_loading title={"책 게시판"} />
				</div>
			</div>
		</div>
	)
