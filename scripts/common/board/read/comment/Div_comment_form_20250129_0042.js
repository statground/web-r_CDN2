function Div_comment_form(props) {
	...
	return (
		<div class={props.class}>
			...
			<div id={`div_community_read_comment_new_${isNewComment ? "form" : commentId + "_form"}`}
				class="w-full"></div>
			<div class="w-full" 
				...
				<div class="flex flex-col justify-between items-center w-full space-x-2 space-y-2">
					<div class="flex flex-row justify-start items-center w-full space-x-2">
						...
						<p id={"txt_file_delete_" + commentId} class="hidden" onClick={() => click_delete_file(commentId)}>
