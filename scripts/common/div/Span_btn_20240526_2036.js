...
function Span_btn_user(props) {
	if (props.role == "관리자") {
		return (
			<span class={class_span_btn_default + " text-xs bg-yellow-100 text-yellow-800"}>
		...
		return (
			<span class={class_span_btn_default + " text-xs bg-red-100 text-red-800"}>
				<img src="https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/board_user.svg" class="w-3 h-3 mr-1" />
				{props.user_nickname}
			</span>
		)
		...
		return (
			<span class={class_span_btn_default + " text-xs bg-gray-100 text-gray-800"}>
				<img src="https://cdn.jsdelivr.net/gh/statground/web-r_CDN/images/svg/board_user.svg" class="w-3 h-3 mr-1" />
				{props.user_nickname}
			</span>
		)
