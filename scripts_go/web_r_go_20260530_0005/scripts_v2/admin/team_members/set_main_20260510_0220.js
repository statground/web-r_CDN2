...
function SpecialAccountsApp(props) {
  ...
  const filteredAccounts = React.useMemo(function () {
    if (!normalizedSearch) return accounts;
    return accounts.filter(function (account) {
      return [account.email, account.nickname, account.realname, account.role_name, account.special_account_kind].map(function (value) {
  ...
  function renderAdminTools() {
    return React.createElement("section", { className: "rounded-lg border border-slate-200 bg-white p-4 shadow-sm" },
      React.createElement("form", { onSubmit: submitAdminSearch, className: "flex flex-col gap-2 md:flex-row" },
        React.createElement("input", {
          type: "search",
          value: search,
  ...
  function renderCreateSpecialTools() {
    return React.createElement("section", { className: "rounded-lg border border-slate-200 bg-white p-4 shadow-sm" },
      React.createElement("form", { onSubmit: submitCreateSpecial, className: "grid grid-cols-5 gap-2 md:grid-cols-1" },
        React.createElement("input", {
          type: "email",
  ...
  function renderAccountTable() {
    ...
    const rows = isAdminScope ? accounts : filteredAccounts;
    return React.createElement("section", { className: "rounded-lg border border-gray-200 bg-white shadow" },
      ...
      isAdminScope ? null : React.createElement("div", { className: "border-b border-slate-100 p-3" },
        React.createElement("input", {
          type: "search",
          value: search,
          onChange: function (event) { setSearch(event.target.value); },
