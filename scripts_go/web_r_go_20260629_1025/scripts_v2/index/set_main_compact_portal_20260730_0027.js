(function installWebRCompactPortal202607300027(window, document) {
  ...
  if (window.__webrCompactPortal202607300027Installed) {
    return;
  }
  window.__webrCompactPortal202607300027Installed = true;
  ...
  function setMain() {
    ...
    if (!root || root.dataset.webrCompactPortal === "20260730_0027") {
      return;
    }
    root.dataset.webrCompactPortal = "20260730_0027";
