(function installWebRCompactPortal202607261653(window, document) {
  "use strict";

  if (window.__webrCompactPortal202607261653Installed) {
    return;
  }
  window.__webrCompactPortal202607261653Installed = true;
  ...
  function setMain() {
    ...
    if (!root || root.dataset.webrCompactPortal === "20260726_1653") {
      return;
    }
    root.dataset.webrCompactPortal = "20260726_1653";
