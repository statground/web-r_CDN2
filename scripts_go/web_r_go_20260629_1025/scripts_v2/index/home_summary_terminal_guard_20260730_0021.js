(function installWebRHomeSummaryTerminalGuard202607300021(window, document) {
  "use strict";

  if (window.__webrHomeSummaryTerminalGuard202607300021Installed) {
    return;
  }
  window.__webrHomeSummaryTerminalGuard202607300021Installed = true;
