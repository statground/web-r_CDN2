(function (global) {
  ...
  if (global.__webrMembershipPage202608152228) {
    return;
  }
  global.__webrMembershipPage202608152228 = true;
  let userinfo = null;
  let products = [];
  ...
  const MembershipProductCard = ({
    ...
    return /*#__PURE__*/React.createElement("article", {
    ...
    }, "/\uB144")), /*#__PURE__*/React.createElement(ProductAction, {
      product: product,
      selected: selected,
      label: "\uC120\uD0DD"
    }), (product.features || []).length > 0 && /*#__PURE__*/React.createElement("ul", {
      className: "mt-6 mb-8 space-y-4 text-left text-sm leading-6",
      role: "list"
      ...
      "aria-hidden": "true"
    }, "\u2713"), /*#__PURE__*/React.createElement("span", null, feature)))));
  };
  const TeamMembershipCard = () => {
    ...
    }, "\uBCF8\uC778 \uD3EC\uD568 \uC804\uCCB4 ", quantity, "\uC11D \xB7 \uCD1D ", money((Number(product.unit_price || product.price) || 0) * quantity), "\uC6D0")), /*#__PURE__*/React.createElement(ProductAction, {
      product: product,
      selected: selected,
      label: "\uC120\uD0DD"
    }), (product.features || []).length > 0 && /*#__PURE__*/React.createElement("ul", {
