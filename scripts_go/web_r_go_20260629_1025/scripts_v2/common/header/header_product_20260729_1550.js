(function installWebRProductHeader202607291550(window, document) {
"use strict";

if (window.__webrProductHeader202607291550Installed) {
  return;
}
window.__webrProductHeader202607291550Installed = true;
