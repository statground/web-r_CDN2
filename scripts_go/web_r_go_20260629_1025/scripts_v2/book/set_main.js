...
(function() {
  ...
  window.WebRBookPages.detail = async function set_main_detail() {
    ...
    function PlainTextSection({ title, content, contents = false }) {
      ...
      return /* @__PURE__ */ React.createElement("section", { className: "bd-text-section", "aria-label": title }, /* @__PURE__ */ React.createElement("h3", null, title), longContents ? /* @__PURE__ */ React.createElement("div", { className: "bd-toc-toolbar" }, /* @__PURE__ */ React.createElement("span", null, expanded ? `목차 ${items.length}개 항목 전체 표시` : `목차 ${items.length}개 항목 중 12개 표시`), /* @__PURE__ */ React.createElement("button", { type: "button", "aria-controls": "book-plain-contents-list", "aria-expanded": expanded, onClick: () => setExpanded((value) => !value) }, expanded ? "목차 접기" : "목차 전체 보기")) : null, contents && items.length > 1 ? /* @__PURE__ */ React.createElement("ol", { className: "bd-plain-toc", id: "book-plain-contents-list" }, items.map((item, index) => /* @__PURE__ */ React.createElement("li", { key: index, hidden: longContents && !expanded && index >= 12 }, item))) : /* @__PURE__ */ React.createElement("div", { className: "bd-plain-prose" }, items.map((item, index) => /* @__PURE__ */ React.createElement("p", { key: index }, item))));
    }
