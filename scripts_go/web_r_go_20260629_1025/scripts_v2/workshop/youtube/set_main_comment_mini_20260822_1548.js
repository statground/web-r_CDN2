...
function Span_btn_article_new(props) {
  return normalizeBool(props.toggle) ? /* @__PURE__ */ React.createElement(WebRStatusBadge, { tone: "new", label: "NEW" }) : null;
}
function Span_btn_article_secret(props) {
  return normalizeBool(props.toggle) ? /* @__PURE__ */ React.createElement(WebRStatusBadge, { tone: "secret", label: "SECRET" }) : null;
}
function Span_btn_comment_secret(props) {
  return normalizeBool(props.toggle) ? /* @__PURE__ */ React.createElement(WebRStatusBadge, { tone: "secret", label: "SECRET" }) : null;
}
function Span_btn_my_article(props) {
  return props.toggle === "writer" ? /* @__PURE__ */ React.createElement(WebRStatusBadge, { tone: "my", label: "MY" }) : null;
}
...
const editorConfig = {
  ...
  if (newFormEl && getCurrentUsername() !== "") {
    commentEditors["new"] = WebRSolidEdit.mountEditor(newFormEl, { height: "250px", placeholder: "내용을 입력해주세요.", toolbarSize: "mini" });
  ...
  data_comment_upper.forEach((comment) => {
    ...
    if (!replyEl)
      return;
    commentEditors[comment.uuid] = WebRSolidEdit.mountEditor(replyEl, { height: "250px", placeholder: "내용을 입력해주세요.", toolbarSize: "mini" });
...
async function click_btn_edit_comment(uuid_comment) {
  ...
  commentEditors[uuid_comment] = WebRSolidEdit.mountEditor(document.querySelector("#div_comment_editor_main_" + uuid_comment), { height: "250px", placeholder: "내용을 입력해주세요.", toolbarSize: "mini" });
