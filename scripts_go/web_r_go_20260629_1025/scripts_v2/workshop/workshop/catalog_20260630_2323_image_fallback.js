const WorkshopCatalogPage = (() => {
  ...
  function workshopCoverImageURL(item) {
    const cover = normalizeFallbackImageURL(displayImageURL(item && item.cover_image_url));
    return cover || fallbackImageForItem(item);
  }
