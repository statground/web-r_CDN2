...
const IntroNoticeList = /* @__PURE__ */ (() => {
    ...
    if (search_text == null || search_text == "") {
	  ...
	  async function get_article_list(mode2) {
	    const ArticleList = ({ data: data2, isMain = false }) => {
	      ...
	      const listContent = /* @__PURE__ */ React.createElement("div", { class: "flex w-full flex-col items-stretch gap-3" }, article_list.length > 0 ? article_list : /* @__PURE__ */ React.createElement("div", { class: "rounded-lg border border-amber-200 bg-amber-50 px-4 py-4 text-sm text-amber-800" }, "\uD45C\uC2DC\uD560 \uACF5\uC9C0\uC0AC\uD56D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4."), /* @__PURE__ */ React.createElement("div", { id: `div_article_list_${page_num + 1}`, class: "w-full" }));
	      if (!isMain)
	        return listContent;
	      return /* @__PURE__ */ React.createElement("section", { class: "w-full rounded-lg border border-slate-200 bg-slate-50 p-3 md:p-4" }, /* @__PURE__ */ React.createElement("div", { class: "mb-4 flex flex-col gap-1 md:flex-row md:items-end md:justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { class: "text-sm font-semibold text-blue-700" }, "\uACF5\uC9C0 \uBAA9\uB85D"), /* @__PURE__ */ React.createElement("p", { class: "text-sm text-slate-500" }, "\uC11C\uBE44\uC2A4 \uBCC0\uACBD\uACFC \uC6B4\uC601 \uC548\uB0B4\uB97C \uC2DC\uAC04\uC21C\uC73C\uB85C \uD655\uC778\uD569\uB2C8\uB2E4.")), article_counter > 0 && /* @__PURE__ */ React.createElement("p", { class: "text-xs text-slate-500" }, "\uC804\uCCB4 ", noticeNumber(article_counter), "\uAC74")), listContent);
	    };
    toggle_page = true;
    const request_data = new FormData();
  ...
  function notice_list_set_main() {
    function Div_main() {
      return /* @__PURE__ */ React.createElement("div", { class: "flex w-full flex-col items-center px-4 py-8 md:px-8" }, /* @__PURE__ */ React.createElement("div", { class: "w-full max-w-5xl" }, /* @__PURE__ */ React.createElement(Div_page_header, { title: header_title, subtitle: header_subtitle }), /* @__PURE__ */ React.createElement("div", { id: "div_community_list", class: "w-full space-y-4" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col gap-4" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col gap-3 rounded-lg border border-blue-100 bg-blue-50 px-4 py-4 md:flex-row md:items-center md:justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { class: "text-sm font-semibold text-blue-800" }, "Web-R \uACF5\uC9C0\uC0AC\uD56D"), /* @__PURE__ */ React.createElement("p", { class: "text-sm leading-6 text-slate-600" }, "\uC11C\uBE44\uC2A4 \uC548\uB0B4, \uBCC0\uACBD \uC0AC\uD56D, \uC6B4\uC601 \uACF5\uC9C0\uB9CC \uBAA8\uC544 \uBCF4\uC5EC\uC90D\uB2C8\uB2E4.")), /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
          onClick: () => gv_username == "" ? alert("\uB85C\uADF8\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.") : location.href = init_url + "write/",
          class: "inline-flex min-h-[40px] w-full items-center justify-center rounded-lg bg-blue-700 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-200 md:w-auto"
        },
        "\uACF5\uC9C0 \uC791\uC131"
      )), /* @__PURE__ */ React.createElement("div", { id: "div_article_list", class: "w-full" }, /* @__PURE__ */ React.createElement("section", { class: "w-full rounded-lg border border-slate-200 bg-slate-50 p-3 md:p-4" }, /* @__PURE__ */ React.createElement(Div_article_list_skeleton, null)))))));
    }
