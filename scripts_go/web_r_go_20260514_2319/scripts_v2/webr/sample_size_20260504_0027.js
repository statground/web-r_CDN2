...
function set_main() {
  function App() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "min-h-[calc(100vh-130px)] bg-slate-50" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto flex w-full max-w-5xl flex-col gap-5 px-4 py-6 md:px-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-start justify-between gap-3" }, /*  */ React.createElement(Div_page_header, { title: "\uC0D8\uD50C \uC218\uC758 \uACC4\uC0B0" }), /*  */ React.createElement("span", { className: "rounded border border-slate-200 bg-white px-3 py-1 text-sm text-slate-600" }, status)), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-5 lg:grid-cols-[360px_minmax(0,1fr)]" }, /* @__PURE__ */ React.createElement("aside", { className: "space-y-4 rounded border border-slate-200 bg-white p-4" }, /* @__PURE__ */ React.createElement("select", { value: test, onChange: (e) => setTest(e.target.value), className: "w-full rounded border-slate-300 text-sm" }, /* @__PURE__ */ React.createElement("option", { value: "two-mean" }, "\uB450 \uD3C9\uADE0 \uBE44\uAD50"), /* @__PURE__ */ React.createElement("option", { value: "two-prop" }, "\uB450 \uBE44\uC728 \uBE44\uAD50"), /* @__PURE__ */ React.createElement("option", { value: "one-mean" }, "\uD55C \uD3C9\uADE0 \uAC80\uC815")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-2 sm:grid-cols-2" }, test === "two-mean" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("input", { type: "number", value: params.mean1, onChange: (e) => setP("mean1", e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { type: "number", value: params.mean2, onChange: (e) => setP("mean2", e.target.value), className: "rounded border-slate-300 text-sm" })) : null, test === "two-prop" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("input", { type: "number", step: ".01", value: params.p1, onChange: (e) => setP("p1", e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { type: "number", step: ".01", value: params.p2, onChange: (e) => setP("p2", e.target.value), className: "rounded border-slate-300 text-sm" })) : null, test === "one-mean" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("input", { type: "number", value: params.mu, onChange: (e) => setP("mu", e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { type: "number", value: params.mu0, onChange: (e) => setP("mu0", e.target.value), className: "rounded border-slate-300 text-sm" })) : null, /* @__PURE__ */ React.createElement("input", { type: "number", value: params.sd, onChange: (e) => setP("sd", e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { type: "number", step: ".01", value: params.power, onChange: (e) => setP("power", e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { type: "number", step: ".01", value: params.alpha, onChange: (e) => setP("alpha", e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { type: "number", step: ".01", value: params.loss, onChange: (e) => setP("loss", e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { type: "number", step: ".1", value: params.ratio, onChange: (e) => setP("ratio", e.target.value), className: "rounded border-slate-300 text-sm" })), /* @__PURE__ */ React.createElement("button", { type: "button", disabled: busy, onClick: run, className: "w-full rounded bg-teal-700 px-4 py-2 text-sm font-semibold text-white hover:bg-teal-800 disabled:bg-slate-400" }, busy ? "\uACC4\uC0B0 \uC911" : "\uACC4\uC0B0"), error ? /* @__PURE__ */ React.createElement("div", { className: "rounded border border-rose-200 bg-rose-50 px-3 py-2 text-sm text-rose-700" }, error) : null), /* @__PURE__ */ React.createElement("main", { className: "rounded border border-slate-200 bg-white p-4" }, result ? /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-3 md:grid-cols-2" }, /* @__PURE__ */ React.createElement("div", { className: "rounded border border-slate-200 p-4" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500" }, "Group A"), /* @__PURE__ */ React.createElement("p", { className: "text-3xl font-bold" }, result.n1), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-500" }, "adjusted ", result.adj1)), result.n2 ? /* @__PURE__ */ React.createElement("div", { className: "rounded border border-slate-200 p-4" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500" }, "Group B"), /* @__PURE__ */ React.createElement("p", { className: "text-3xl font-bold" }, result.n2), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-500" }, "adjusted ", result.adj2)) : null) : /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-500" }, "\uACC4\uC0B0 \uACB0\uACFC\uAC00 \uC5EC\uAE30\uC5D0 \uD45C\uC2DC\uB429\uB2C8\uB2E4.")))));
  }
