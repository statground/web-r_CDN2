...
function set_main() {
  function Div_main() {
    return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center w-full space-y-[25px] mt-[50px] px-[10px] py-[0px] md:px-[100px] md:py-[20px]" }, /* @__PURE__ */ React.createElement("div", { id: "div_main_header", class: "w-full" }), /* @__PURE__ */ React.createElement("div", { id: "div_home_service_hub", class: "w-full" }), /* @__PURE__ */ React.createElement("div", { id: "div_main_statistics", class: "w-full" }), /* @__PURE__ */ React.createElement("div", { class: "w-full", id: "div_book_list" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-row justify-center items-center w-full h-[150px] mb-4 bg-gray-300 animate-pulse" })), /* @__PURE__ */ React.createElement("div", { id: "div_main_board", class: "w-full" }));
  }
  ...
  ReactDOM.render(/* @__PURE__ */ React.createElement(Div_home_service_hub, null), document.getElementById("div_home_service_hub"));
