(function() {
  ...
  function Div_main() {
    return h("main", { className: "w-full bg-white text-gray-950" }, h("section", { className: "px-5 pt-14 pb-12 md:px-8 md:pt-20" }, h("div", { className: "mx-auto max-w-6xl text-center" }, h("p", { className: "text-base font-semibold text-sky-700" }, "국내 최대의 데이터 커뮤니티"), h("h1", { className: "mt-3 text-4xl font-extrabold text-gray-950 md:text-6xl" }, "주식회사 통계마당"), h("p", { className: "mx-auto mt-5 max-w-3xl text-lg leading-8 text-gray-600" }, "통계마당은 통계와 데이터를 배우고 쓰는 사람들이 서로의 지식과 경험을 나누며 더 멀리 갈 수 있도록 커뮤니티, 교육, 도구를 함께 만들어 온 회사입니다."))), h(StorySection, null), h(PeopleSection, null), h(LogoRailSection, null));
  }
  function set_main() {
