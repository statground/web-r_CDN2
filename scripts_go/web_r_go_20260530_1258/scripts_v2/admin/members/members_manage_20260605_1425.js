...
function AdminMembersManageMain(props) {
  ...
  ))), renderCreatePanel(), /* @__PURE__ */ React.createElement("div", { className: "mb-4 flex flex-col gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex w-full flex-col gap-2 md:max-w-[560px] md:flex-row" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
  ...
  ), /* @__PURE__ */ React.createElement("button", { type: "button", className: "inline-flex min-h-[40px] min-w-[88px] items-center justify-center gap-2 rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 disabled:opacity-50", disabled: listLoading || pendingPage !== 0 || pendingSearch, onClick: () => applyMemberSearch() }, pendingSearch ? /* @__PURE__ */ React.createElement("span", { className: "h-3 w-3 animate-spin rounded-full border-2 border-white/60 border-t-white", "aria-hidden": "true" }) : null, /* @__PURE__ */ React.createElement("span", null, "\uAC80\uC0C9"))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center justify-between gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2" }, paymentFilterOptions.map((option) => /* @__PURE__ */ React.createElement("button", { key: option.value, type: "button", "aria-pressed": paymentFilter === option.value, className: "inline-flex min-h-[36px] items-center justify-center gap-2 whitespace-nowrap rounded-md border px-3 py-1.5 text-sm font-semibold " + (paymentFilter === option.value ? "border-blue-500 bg-blue-50 text-blue-700" : "border-slate-200 bg-white text-slate-700"), onClick: () => {
