...
function Div_main(props) {
  ...
  ))), /* @__PURE__ */ React.createElement(Div_sub_title, { title: "\uD37C\uB110 \uC694\uC57D" }), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-6 p-4 w-full" }, /* @__PURE__ */ React.createElement(
    Kpi,
    {
      title: "\uBC29\uBB38\uC790",
      idVal: "kpi_visit_val",
...
function draw_chart(inputData, activeTabId, drawToken) {
    ...
    chartFunnel.setOption({
      ...
      tooltip: {
	        ...
	        formatter: function(p) {
	          return p.name + ": " + (+p.value || 0).toLocaleString() + (p.name === "\uACB0\uC81C" ? "\uAC74" : "\uBA85");
	        }
	      },
      series: [
        {
  ...
  if (chartConv) {
    const cats = ["\uBC29\uBB38\u2192\uAC00\uC785", "\uAC00\uC785\u2192\uB85C\uADF8\uC778", "\uB85C\uADF8\uC778\u2192\uAC8C\uC2DC\uD310", "\uB85C\uADF8\uC778\u2192\uC571", "\uC571\u2192\uACB0\uC81C"];
    const vals = [
      isNaN(cr1) ? 0 : cr1,
      isNaN(cr2) ? 0 : cr2,
      isNaN(cr3) ? 0 : cr3,
