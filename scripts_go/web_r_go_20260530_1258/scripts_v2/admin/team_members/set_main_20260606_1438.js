...
function TeamMembersApp(props) {
  ...
  function renderTeam(team, index) {
    ...
    return React.createElement("section", { key: teamUUID, className: "w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm" },
      React.createElement("button", {
        type: "button",
        ...
        React.createElement("div", { className: "flex flex-col gap-2 md:flex-row md:items-start md:justify-between" },
          React.createElement("div", { className: "min-w-0" },
            React.createElement("h3", { className: "truncate text-lg font-extrabold text-slate-950 md:text-xl" }, team.team_name || "이름 없는 팀"),
          ...
          React.createElement("div", { className: "flex flex-wrap gap-2 text-sm" },
            ...
            React.createElement("span", { className: "rounded-md border border-slate-200 bg-white px-3 py-1 font-semibold text-slate-700" }, isOpen ? "접기" : "펼치기")
          )
        ),
      ...
      isOpen ? React.createElement("div", { className: "flex flex-col gap-4 border-t border-slate-200 bg-white p-4 md:p-5" },
        ...
        React.createElement("div", { className: "w-full overflow-x-auto" },
          React.createElement("table", { className: "min-w-full text-left text-xs text-gray-600 md:text-sm" },
            ...
            React.createElement("tbody", null,
              members.length === 0 ? React.createElement("tr", null,
                React.createElement("td", { colSpan: isInternal ? "9" : "8", className: "px-3 py-6 text-center text-gray-400" }, "등록된 팀원이 없습니다.")
              ) : members.map(function (member) { return renderMember(team, member); })
            )
          )
        )
      ) : null
  ...
  return React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-12 justify-center item-center w-full px-[10px] py-[20px] md:px-[100px]" },
    ...
    React.createElement("div", { className: "md:col-span-10 justify-center item-center" },
      ...
      React.createElement("div", { className: "w-full bg-white border border-gray-200 rounded-lg shadow" },
      ...
      React.createElement("div", { className: "w-full bg-white border border-gray-200 rounded-lg shadow" },
        React.createElement("div", { className: "p-4 bg-white rounded-lg md:p-6" },
          React.createElement("div", { className: "mb-4 flex flex-col gap-1 md:flex-row md:items-end md:justify-between" },
            React.createElement("h5", { className: "text-2xl font-extrabold leading-none tracking-tight text-gray-900" }, "팀 목록"),
            React.createElement("p", { className: "text-sm text-slate-500" }, "기본값은 접힘 상태입니다.")
          ),
