...
async function get_main() {
  ...
  const loadSection = function(url) {
  ...
  await Promise.all([
    loadSection("/admin/ajax_get_admin_webr_counts/"),
    loadSection("/admin/ajax_get_admin_webr_app_groups/"),
    loadSection("/admin/ajax_get_admin_webr_apps/"),
    loadSection("/admin/ajax_get_admin_webr_graph/")
  ]);
  render(true);
}
