...
const menuSections = {
  ...
  book: {
    title: "도서",
    panelTitle: "R 도서 허브",
    panelText: "R 관련 도서, 번역서와 학습 자료를 한곳에서 탐색합니다.",
    panelLink: ["/book/", "R 도서 모음 보기"],
...
function MegaFeaturePanel(props) {
  ...
  return h("aside", { className: "flex min-h-[220px] flex-col justify-center rounded-lg px-2 py-4 md:min-h-0" },
    h("h3", { className: "text-2xl font-extrabold tracking-normal text-gray-950" }, section.panelTitle),
    h("p", { className: "mt-5 max-w-[280px] text-xl leading-relaxed text-gray-600" }, section.panelText),
    h("a", {
      href: link[0],
      className: "mt-7 inline-flex items-center text-xl font-bold text-blue-700 hover:text-blue-800"
    }, link[1] + " →")
  );
}
