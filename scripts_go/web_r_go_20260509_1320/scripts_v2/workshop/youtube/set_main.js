...
function YouTubeListPage(props) {
  return /* @__PURE__ */ React.createElement("div", { class: "w-full bg-white" }, /* @__PURE__ */ React.createElement("div", { class: "mx-auto flex w-full max-w-screen-2xl flex-col gap-8 px-6 py-8 md:px-4" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col gap-4" }, /* @__PURE__ */ React.createElement(Div_page_header, { title: header_title, subtitle: header_subtitle }), props.showWriteButton && /* @__PURE__ */ React.createElement("div", { class: "flex justify-end" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => location.href = init_url + "write/", class: "h-10 rounded-lg bg-gray-900 px-5 text-sm font-bold text-white hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-200" }, "\uAE00\uC4F0\uAE30"))), /* @__PURE__ */ React.createElement(YoutubeSearchBar, null), /* @__PURE__ */ React.createElement("div", { id: "div_community_list", class: "w-full" }, /* @__PURE__ */ React.createElement("div", { id: "div_article_list", class: "w-full" }, /* @__PURE__ */ React.createElement(Div_article_list_skeleton, null)))));
}
