...
function adminMembersInjectCompactStyles() {
  if (document.getElementById("webr-admin-members-compact-style"))
    return;
  const style = document.createElement("style");
  style.id = "webr-admin-members-compact-style";
  style.textContent = `
    .webr-admin-members-compact > div:nth-child(2) {
      display: grid;
      gap: 12px;
    }
    .webr-admin-members-compact > div:nth-child(2) > div:nth-child(-n+4) {
      margin-bottom: 0 !important;
    }
    .webr-admin-members-compact > div:nth-child(2) > div:nth-child(-n+4) > div {
      padding: 16px !important;
    }
    .webr-admin-members-compact > div:nth-child(2) > div:nth-child(-n+4) h5 {
      margin-bottom: 10px !important;
      font-size: 1.45rem !important;
      line-height: 1.2 !important;
    }
    .webr-admin-members-compact > div:nth-child(2) > div:nth-child(-n+4) dl {
      gap: 10px 14px !important;
      padding: 4px !important;
      align-items: stretch;
    }
    .webr-admin-members-compact > div:nth-child(2) > div:nth-child(-n+4) dl > div {
      flex-basis: 132px !important;
      min-width: 118px;
      padding: 8px !important;
      justify-content: flex-start;
    }
    .webr-admin-members-compact > div:nth-child(2) > div:nth-child(-n+4) dt {
      font-size: 1.55rem !important;
      line-height: 1.15 !important;
    }
    .webr-admin-members-compact > div:nth-child(2) > div:nth-child(-n+4) dd {
    ...
    @media (min-width: 1024px) {
      ...
      .webr-admin-members-compact > div:nth-child(2) > div:nth-child(n+5) {
        grid-column: 1 / -1;
      }
    }
  `;
...
get_main = async function() {
  adminMembersInjectCompactStyles();
