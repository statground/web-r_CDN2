...
function WorkshopListPage() {
  return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center py-8 px-20 w-full max-w-screen-sm mx-auto md:px-8" }, /* @__PURE__ */ React.createElement(Div_page_header, { title: header_title, subtitle: header_subtitle }), /* @__PURE__ */ React.createElement("div", { id: "div_community_list", class: "flex flex-col justify-center items-center w-full space-y-4" }, /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-3 justify-center items-start w-full gap-4 md:grid-cols-1" }, /* @__PURE__ */ React.createElement("div", { id: "div_article_list", class: "col-span-2 w-full" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uAE00" }))), /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full space-y-4" }, /* @__PURE__ */ React.createElement(
    ...
    "\uAE00\uC4F0\uAE30"
  ), /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center w-full space-y-2 border border-gray-200 p-4 rounded-xl" }, /* @__PURE__ */ React.createElement("p", { class: "flex flex-row text-start w-full" }, "\uAC80\uC0C9"), /* @__PURE__ */ React.createElement("input", { id: "txt_search", type: "text", class: "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:ring-blue-500 focus:border-blue-500" }), /* @__PURE__ */ React.createElement("div", { class: "flex flex-row justify-end items-center w-full" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
...
async function get_article_list(mode_value) {
  ...
  if (mode_value === "init" || mode_value === "search") {
    ...
    page_num += 1;
    ReactDOM.render(/* @__PURE__ */ React.createElement(Div_article_list_skeleton, null), document.getElementById("div_article_list_" + page_num));
  }
  ...
  const chunk = Object.keys(data.list || {}).map((key) => /* @__PURE__ */ React.createElement(Div_new_article_list, { key, data: data.list[key] }));
  const placeholderId = "div_article_list_" + (page_num + 1);
  if (mode_value === "init" || mode_value === "search") {
    ReactDOM.render(
      /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uAE00" }), /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full space-y-2" }, chunk, /* @__PURE__ */ React.createElement("div", { id: placeholderId, class: "w-full" }))),
      document.getElementById("div_article_list")
    );
  } else {
    ReactDOM.render(
      /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full space-y-2" }, chunk, /* @__PURE__ */ React.createElement("div", { id: placeholderId, class: "w-full" })),
...
function renderWorkshopListPage() {
  ...
  article_counter = 0;
  toggle_page = false;
  ReactDOM.render(/* @__PURE__ */ React.createElement(WorkshopListPage, null), document.getElementById("div_main"));
...
function renderWorkshopReadPage() {
  ...
  commentFiles = [];
  commentEditors = {};
  ReactDOM.render(/* @__PURE__ */ React.createElement(WorkshopReadPage, null), document.getElementById("div_main"));
