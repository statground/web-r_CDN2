...
const TEAM_ADMIN_SCOPES = {
  ...
  bot_team: {
    title: "Bot 팀",
    loading: "Bot 팀 현황을 불러오고 있습니다.",
    empty: "Bot 팀에 해당하는 계정이 없습니다.",
    searchPlaceholder: "Bot 팀 계정 검색",
...
function TeamMembersApp(props) {
  ...
  function renderSummaryMetrics() {
    ...
    return [
      React.createElement(TeamMetric, { key: "team_count", title: "팀 수", value: teamAdminFormatNumber(displaySummary.team_count) + "팀" }),
      React.createElement(TeamMetric, { key: "regular", title: "정회원 팀", value: teamAdminFormatNumber(displaySummary.regular_team_total) + "팀" }),
      React.createElement(TeamMetric, { key: "vip", title: "VIP회원 팀", value: teamAdminFormatNumber(displaySummary.vip_team_total) + "팀" }),
      React.createElement(TeamMetric, { key: "seat_limit", title: "총 좌석", value: teamAdminFormatNumber(displaySummary.seat_limit_total) + "석" }),
      React.createElement(TeamMetric, { key: "seat_used", title: "사용 좌석", value: teamAdminFormatNumber(displaySummary.seat_used_total) + "석" }),
      React.createElement(TeamMetric, { key: "remaining", title: "잔여 좌석", value: teamAdminFormatNumber(displaySummary.remaining_total) + "석" }),
      React.createElement(TeamMetric, { key: "ledger", title: "결제 합계", value: teamAdminMoney(displaySummary.ledger_amount_total) })
    ];
  }
