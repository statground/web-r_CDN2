...
function set_main() {
  ...
  function NotebookListPage() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col justify-center items-center py-8 px-6 w-full max-w-6xl mx-auto md:px-20" }, /* @__PURE__ */ React.createElement(Div_page_header, { title: "Web-R Notebook" }), /* @__PURE__ */ React.createElement("div", { id: "div_notebook_list", className: "flex flex-col justify-center items-center w-full mt-4" }, /* @__PURE__ */ React.createElement("div", { id: "div_notebook_main", className: "w-full" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-row justify-between items-center w-full gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("h2", { className: "text-sm font-semibold text-slate-900" }, "\uB0B4 \uB178\uD2B8\uBD81"), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] px-2 py-0.5 rounded-full bg-white border border-slate-200 text-slate-600" }, notebooks.length, "\uAC1C")), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
