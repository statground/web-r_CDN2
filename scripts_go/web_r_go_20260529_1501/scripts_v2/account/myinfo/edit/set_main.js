...
async function get_userinfo() {
  ...
  function Div_main_userinfo(props) {
    return /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-1 justify-center items-start gap-8 w-full md:grid-cols-5" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-blue-100 rounded-xl w-full px-4 py-8 space-y-2" }, /* @__PURE__ */ React.createElement("p", { class: "text-sm" }, props.data.email), /* @__PURE__ */ React.createElement("p", { class: "text-2xl font-extrabold" }, props.data.name), /* @__PURE__ */ React.createElement("p", { class: "text-sm" }, props.data.realname, "\u3000|\u3000", props.data.gender), /* @__PURE__ */ React.createElement("div", { class: "py-4" }), /* @__PURE__ */ React.createElement("p", { class: "text-lg font-extrabold" }, props.data.role), /* @__PURE__ */ React.createElement("p", { class: "text-sm" }, "\uAC00\uC785 \uC77C\uC790: ", props.data.date_joined), props.data.expired_at == null ? /* @__PURE__ */ React.createElement("p", { class: "text-sm" }, "\uD68C\uC6D0\uB4F1\uAE09 \uB9CC\uB8CC\uC77C: \uBB34\uC81C\uD55C") : /* @__PURE__ */ React.createElement("p", { class: "text-sm" }, "\uD68C\uC6D0\uB4F1\uAE09 \uB9CC\uB8CC\uC77C: ", props.data.expired_at), /* @__PURE__ */ React.createElement("div", { class: "py-4" }), props.data.email_subscription == 1 ? /* @__PURE__ */ React.createElement("p", { class: "text-sm text-green-500" }, "\uC774\uBA54\uC77C \uC218\uC2E0 \uD5C8\uC6A9") : /* @__PURE__ */ React.createElement("p", { class: "text-sm text-gray-500" }, "\uC774\uBA54\uC77C \uC218\uC2E0 \uAC70\uBD80"), /* @__PURE__ */ React.createElement("div", { class: "py-4" }), /* @__PURE__ */ React.createElement("div", { class: "w-full", id: "div_buttons" }, /* @__PURE__ */ React.createElement(Div_buttons, null))), /* @__PURE__ */ React.createElement("div", { class: "md:col-span-4 flex flex-col justify-start items-start rounded-xl w-full" }, /* @__PURE__ */ React.createElement("ul", { class: "flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 w-full" }, /* @__PURE__ */ React.createElement("li", { class: "me-2" }, /* @__PURE__ */ React.createElement("p", { class: class_tab_active }, "\uB0B4 \uC815\uBCF4 \uC218\uC815"))), /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-2 gap-4 justify-center items-center w-full p-4" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col w-full" }, /* @__PURE__ */ React.createElement("label", { for: "txt_name", class: "block mb-2 text-sm font-medium text-gray-900" }, "\uB2C9\uB124\uC784"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        id: "txt_name",
    ...
    )), /* @__PURE__ */ React.createElement("div", { class: "md:col-span-2 flex flex-col w-full" }, /* @__PURE__ */ React.createElement("label", { for: "txt_email", class: "block mb-2 text-sm font-medium text-gray-900" }, "\uC774\uBA54\uC77C (\uB85C\uADF8\uC778 \uD560 \uB54C \uACC4\uC815\uC774 \uD568\uAED8 \uBCC0\uACBD\uB429\uB2C8\uB2E4.)"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        id: "txt_email",
    ...
    ), /* @__PURE__ */ React.createElement("label", { for: "rad_gender_female", class: "w-full py-3 ms-2 text-sm font-medium text-gray-900" }, "\uC5EC\uC131"))))), /* @__PURE__ */ React.createElement("div", { class: "md:col-span-2 flex flex-col w-full" }, /* @__PURE__ */ React.createElement("h3", { class: "block mb-2 text-sm font-medium text-gray-900" }, "\uC774\uBA54\uC77C \uC218\uC2E0 \uD5C8\uC6A9"), /* @__PURE__ */ React.createElement("ul", { class: "flex flex-row justify-center items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg space-x-4" }, /* @__PURE__ */ React.createElement("li", { class: "w-full border-b border-gray-200 sm:border-b-0 sm:border-r" }, /* @__PURE__ */ React.createElement("div", { class: "flex items-center ps-3" }, /* @__PURE__ */ React.createElement(
      "input",
      {
