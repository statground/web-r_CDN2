(function () {
  ...
  function renderLoading(title) {
    ...
    root.innerHTML = [
      ...
      '<span class="mr-2 rounded border border-amber-200 bg-amber-50 px-2 py-1 text-xs font-semibold uppercase tracking-normal text-amber-700">Beta</span>',
  ...
  function renderError() {
    ...
    root.innerHTML = [
      ...
      "\uC77C\uC2DC\uC801\uC73C\uB85C Web-R 2.0 beta \uC571\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",
      "</div></div></div>"
    ].join("");
  }
  ...
  async function secureSetMain() {
    ...
    try {
      ...
      if (window.console && window.console.warn) {
        window.console.warn("Web-R 2.0 beta app load failed");
      }
    }
  }
