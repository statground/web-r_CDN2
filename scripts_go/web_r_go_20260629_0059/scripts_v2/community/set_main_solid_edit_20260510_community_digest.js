...
const COMMUNITY_TABBED_URLS = ["all", "free", "rcommunity", "rblogger", "rproject", "notebook"];
let header_title = "";
...
function DivBoardTabs() {
  ...
  return /* @__PURE__ */ React.createElement("div", { class: "flex flex-wrap items-center gap-2 w-full pt-2" }, /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "all", onClick: () => handleChangeTab("all") }, "\uC804\uCCB4\uBCF4\uAE30"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "free", onClick: () => handleChangeTab("free") }, "\uC790\uC720\uAC8C\uC2DC\uD310"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "rcommunity", onClick: () => handleChangeTab("rcommunity") }, "R Community"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "rblogger", onClick: () => handleChangeTab("rblogger") }, "R-Blogger"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "rproject", onClick: () => handleChangeTab("rproject") }, "R-Project (Official)"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "notebook", onClick: () => handleChangeTab("notebook") }, "Web-R Notebook"));
}
...
function DivCommunityTopTools() {
  return /* @__PURE__ */ React.createElement("div", { class: "w-full border border-gray-200 rounded-xl p-4 bg-white space-y-4" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-wrap items-center justify-between gap-3" }, /* @__PURE__ */ React.createElement(DivBoardTabs, null), /* @__PURE__ */ React.createElement(
    ...
    "\uAE00\uC4F0\uAE30"
  )), /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-[1fr_auto] gap-2 sm:grid-cols-1" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      id: "txt_search",
...
function DivCommunityWidgetHeader() {
  return /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-1 w-full gap-3 sm:grid-cols-2 lg:grid-cols-4" }, /* @__PURE__ */ React.createElement(Div_sidelist_skeleton, { id: "div_article_famous_list", title: "\uCD5C\uADFC \uC778\uAE30 \uAE00" }), /* @__PURE__ */ React.createElement(Div_sidelist_skeleton, { id: "div_new_comment_list", title: "\uCD5C\uADFC \uB313\uAE00" }), /* @__PURE__ */ React.createElement(Div_sidelist_skeleton, { id: "div_my_article_list", title: "\uB0B4\uAC00 \uC4F4 \uAE00" }), /* @__PURE__ */ React.createElement(Div_sidelist_skeleton, { id: "div_my_comment_list", title: "\uB0B4\uAC00 \uC4F4 \uB313\uAE00" }));
}
function ListMain() {
  return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center py-8 px-6 w-full max-w-6xl mx-auto md:px-20" }, /* @__PURE__ */ React.createElement(Div_page_header, { title: header_title, subtitle: header_subtitle }), /* @__PURE__ */ React.createElement("div", { id: "div_community_list", class: "flex flex-col justify-center items-center w-full space-y-4" }, /* @__PURE__ */ React.createElement(DivCommunityTopTools, null), /* @__PURE__ */ React.createElement(DivCommunityWidgetHeader, null), /* @__PURE__ */ React.createElement("div", { id: "div_article_list", class: "w-full" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uAE00" })))));
}
