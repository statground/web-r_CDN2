(function () {
  ...
  function addBetaBadges(root) {
    ...
    targets.forEach(function (heading) {
      if (isBetaBadgeSuppressed(heading)) {
        return;
      }
  ...
  function isBetaBadgeSuppressed(heading) {
    const link = heading && heading.closest ? heading.closest("a[href]") : null;
    const href = link ? String(link.getAttribute("href") || "").trim() : "";
    return href === "/webr/pubmed-wordcloud/" || href.indexOf("/webr/pubmed-wordcloud/") === 0;
  }
