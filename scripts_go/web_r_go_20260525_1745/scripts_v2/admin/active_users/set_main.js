...
function activeUsersPeriod(period) {
...
function ActiveUsersDashboard() {
  ...
  React.useEffect(function() {
    ["monthly", "daily", "yearly", "total"].forEach(function(period) {
      activeUsersPeriod(period).then(function(next) {
        setData(function(prev) {
          return Object.assign({}, prev, next || {});
        });
      }).catch(function(err) {
        console.error(err);
        setError("일부 활성 사용자 데이터를 불러오지 못했습니다.");
      });
    });
  }, []);
...
async function get_main() {
  ReactDOM.render(
    /* @__PURE__ */ React.createElement(ActiveUsersDashboard, null),
