...
const COMMUNITY_TABBED_URLS = ["all", "free", "rblogger", "rproject", "notebook"];
let header_title = "";
...
function AttachmentDropZone(props) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { class: "flex flex-row justify-between items-center gap-3 md:flex-col md:items-start" }, /* @__PURE__ */ React.createElement("div", { class: "text-sm text-gray-700" }, /* @__PURE__ */ React.createElement("p", { class: "font-semibold" }, "\uD30C\uC77C\uC744 \uB04C\uC5B4\uB2E4 \uB193\uAC70\uB098 \uC120\uD0DD\uD574\uC8FC\uC138\uC694."), /* @__PURE__ */ React.createElement("p", { class: "text-xs text-gray-500" }, "\uC5EC\uB7EC \uD30C\uC77C\uC744 \uD55C \uBC88\uC5D0 \uCCA8\uBD80\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.")), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
...
function DivBoardTabs() {
  ...
  return /* @__PURE__ */ React.createElement("div", { class: "flex flex-wrap items-center gap-2 w-full pt-2" }, /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "all", onClick: () => handleChangeTab("all") }, "\uC804\uCCB4\uBCF4\uAE30"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "free", onClick: () => handleChangeTab("free") }, "\uC790\uC720\uAC8C\uC2DC\uD310"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "rblogger", onClick: () => handleChangeTab("rblogger") }, "R-Blogger"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "rproject", onClick: () => handleChangeTab("rproject") }, "R-Project (Official)"), /* @__PURE__ */ React.createElement(TabButton, { active: activeTab === "notebook", onClick: () => handleChangeTab("notebook") }, "Web-R Notebook"));
}
...
function Div_sidebar_notice(props) {
  return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: props.title }), /* @__PURE__ */ React.createElement("span", null, props.message));
}
async function get_article_famous_list() {
  function Div_article_list(props) {
    return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uC778\uAE30 \uAE00" }), /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full space-y-2" }, Object.values(props.data || {}).map((article) => /* @__PURE__ */ React.createElement(Div_new_article_list, { key: article.id || article.uuid, data: article }))));
  }
...
function ListMain() {
  return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center py-8 px-20 w-full max-w-screen-sm mx-auto md:px-8" }, /* @__PURE__ */ React.createElement(Div_page_header, { title: header_title, subtitle: header_subtitle }), /* @__PURE__ */ React.createElement("div", { id: "div_community_list", class: "flex flex-col justify-center items-center w-full space-y-4" }, /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-3 justify-center items-start w-full gap-4 md:grid-cols-1" }, /* @__PURE__ */ React.createElement("div", { id: "div_article_list", class: "col-span-2 w-full" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uAE00" }), /* @__PURE__ */ React.createElement(DivBoardTabs, null))), /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full space-y-4" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
...
async function get_article_list(loadMode) {
  function ArticleList(props) {
    const article_list = Object.keys(props.data || {}).map((key) => /* @__PURE__ */ React.createElement(Div_new_article_list, { key, data: props.data[key] }));
    const listContent = /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-start w-full space-y-2" }, article_list, /* @__PURE__ */ React.createElement("div", { id: `div_article_list_${communityState.page_num + 1}`, class: "w-full" }));
    if (!props.isMain) {
      return listContent;
    }
    return /* @__PURE__ */ React.createElement("div", { class: "flex flex-col justify-center items-center border border-gray-300 rounded-xl space-y-4 w-full p-8" }, /* @__PURE__ */ React.createElement(Div_box_header, { title: "\uCD5C\uC2E0 \uAE00" }), /* @__PURE__ */ React.createElement(DivBoardTabs, null), listContent);
  }
  ...
  ReactDOM.render(
    /* @__PURE__ */ React.createElement(ArticleList, { data: data.list, isMain: loadMode === "init" || loadMode === "search" }),
