...
function Div_main(props) {
  ...
  function Div_app_list({ data: data2 }) {
    const items = Object.keys(data2).map((k) => /* @__PURE__ */ React.createElement("div", { className: "flex flex-row justify-between items-center w-full", key: k }, /* @__PURE__ */ React.createElement("p", null, data2[k].name_app), /* @__PURE__ */ React.createElement("p", null, fmt(data2[k].cnt_connect), "\uD68C (", fmt(data2[k].cnt_user), "\uBA85)")));
    return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col justify-center items-center rounded-xl space-y-4 w-full p-8" }, items);
  }
