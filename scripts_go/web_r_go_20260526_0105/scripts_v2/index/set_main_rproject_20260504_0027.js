...
function Div_home_update_dashboard() {
  ...
  React.useEffect(() => {
    ...
    Promise.all([
      ...
      homePostJSON("/ajax_index_statistics/")
    ]).then(([board, events, books, workshops, youtube, packages, statistics]) => {
      if (!mounted)
        return;
      setHomeState({
        loading: false,
  ...
  const categoryDefs = [
    { id: "packages", label: "R 패키지", href: "/r-ecosystem/packages/", tone: "border-emerald-200 bg-emerald-50 text-emerald-700" },
    { id: "rcommunity", label: "R Community", href: "/community/", tone: "border-blue-200 bg-blue-50 text-blue-700" },
    { id: "ecosystem", label: "R 에코시스템", href: "/r-ecosystem/", tone: "border-cyan-200 bg-cyan-50 text-cyan-700" },
    { id: "community", label: "커뮤니티", href: "/community/", tone: "border-sky-200 bg-sky-50 text-sky-700" },
    { id: "books", label: "도서", href: "/book/", tone: "border-amber-200 bg-amber-50 text-amber-700" },
    { id: "workshops", label: "워크샵", href: "/workshop/", tone: "border-indigo-200 bg-indigo-50 text-indigo-700" },
    { id: "webr", label: "Web-R 실행", href: "/webr/2.0/", tone: "border-slate-200 bg-slate-100 text-slate-700" }
  ];
  ...
  function FeedRow(props) {
    const item = props.item;
    return /* @__PURE__ */ React.createElement("a", { href: item.href, class: "group block border-t border-slate-100 px-4 py-3 first:border-t-0 hover:bg-slate-50" }, /* @__PURE__ */ React.createElement("span", { class: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("span", { class: "min-w-0" }, /* @__PURE__ */ React.createElement("span", { class: "block text-sm font-extrabold leading-5 text-slate-950 group-hover:text-blue-700" }, item.title), item.detail ? /* @__PURE__ */ React.createElement("span", { class: "mt-1 block truncate text-sm text-slate-500" }, item.detail) : null), /* @__PURE__ */ React.createElement("span", { class: "shrink-0 text-xs font-extrabold text-blue-600" }, "열기")), /* @__PURE__ */ React.createElement("span", { class: "mt-2 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-400" }, /* @__PURE__ */ React.createElement("span", { class: "rounded border border-slate-200 bg-white px-1.5 py-0.5 text-slate-600" }, item.source), /* @__PURE__ */ React.createElement("span", null, item.meta)));
  }
  ...
  return /* @__PURE__ */ React.createElement("section", { class: "mx-auto w-full max-w-[1360px]" }, /* @__PURE__ */ React.createElement("div", { class: "rounded-lg border border-slate-200 bg-white p-4 shadow-sm md:p-5" }, /* @__PURE__ */ React.createElement("div", { class: "flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between" }, /* @__PURE__ */ React.createElement("div", { class: "max-w-2xl" }, /* @__PURE__ */ React.createElement("p", { class: "text-sm font-extrabold text-blue-700" }, "영역별 새 소식"), /* @__PURE__ */ React.createElement("h2", { class: "text-2xl font-extrabold text-slate-950" }, "지금 Web-R에서 이어지는 업데이트"), /* @__PURE__ */ React.createElement("p", { class: "mt-2 text-sm leading-6 text-slate-500" }, "각 영역의 최신 항목을 최대 ", CATEGORY_ITEM_LIMIT, "개씩 모았습니다.")), /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-3 gap-2 sm:grid-cols-6" }, quickLinks.map((link) => /* @__PURE__ */ React.createElement("a", { key: link.href, href: link.href, class: "flex h-[74px] flex-col items-center justify-center gap-1 rounded-lg border px-2 text-xs font-extrabold " + link.tone }, /* @__PURE__ */ React.createElement("img", { src: link.icon, alt: "", class: "h-6 w-6 object-contain", loading: "lazy" }), link.title))))), /* @__PURE__ */ React.createElement("div", { class: "mt-3 grid grid-cols-1 items-start gap-3 lg:grid-cols-[minmax(0,1fr)_320px]" }, /* @__PURE__ */ React.createElement("div", { class: "grid grid-cols-1 gap-3 xl:grid-cols-2" }, categories.map((section) => /* @__PURE__ */ React.createElement(CategorySection, { key: section.id, section }))), /* @__PURE__ */ React.createElement("div", { class: "space-y-3" }, /* @__PURE__ */ React.createElement(StatPanel, null), /* @__PURE__ */ React.createElement(LivePanel, null))));
}
