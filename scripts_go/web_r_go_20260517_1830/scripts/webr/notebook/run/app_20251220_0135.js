...
") }
  ...
  useEffect(() => {
    function handleKeyDown(e) {
      ...
      if (isRunAllCombo) {
        if (isViewMode || !canEdit || !ready || busy)
          return;
        e.preventDefault();
        e.stopPropagation();
        runAllCells();
...
${varName}`;
  ...
  return /* @__PURE__ */ React.createElement("div", { className: rootClass }, /* @__PURE__ */ React.createElement("header", { ref: headerRef, className: headerClass }, /* @__PURE__ */ React.createElement("div", { className: "flex w-full flex-col gap-2 lg:flex-row lg:items-center lg:justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex w-full items-center justify-between gap-2 lg:w-auto lg:justify-start" }, /* @__PURE__ */ React.createElement("div", { className: "flex min-w-0 items-center gap-3" }, !isSiteMode && /* @__PURE__ */ React.createElement(
    ...
    "button",
    {
      ...
      className: "inline-flex flex-1 items-center justify-center rounded-full border px-3 py-2 text-xs font-semibold " + (shareMode === 0 ? "border-slate-800 bg-slate-800 text-white" : "border-slate-300 bg-white text-slate-700 hover:bg-slate-50")
    },
    "\u25CF OFF"
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      className: "inline-flex flex-1 items-center justify-center rounded-full border px-3 py-2 text-xs font-semibold " + (shareMode === 2 ? "border-blue-600 bg-blue-600 text-white" : "border-slate-300 bg-white text-slate-700 hover:bg-slate-50")
    },
    "\u25CF \uB9C1\uD06C\uB85C\uB9CC \uACF5\uC720"
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      className: "inline-flex flex-1 items-center justify-center rounded-full border px-3 py-2 text-xs font-semibold " + (shareMode === 1 ? "border-emerald-600 bg-emerald-600 text-white" : "border-slate-300 bg-white text-slate-700 hover:bg-slate-50")
    },
    "\u25CF \uCEE4\uBBA4\uB2C8\uD2F0\uC5D0 \uACF5\uC720"
