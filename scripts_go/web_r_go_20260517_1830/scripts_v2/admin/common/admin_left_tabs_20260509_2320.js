(function () {
  const STYLE_ID = "webr-admin-left-tabs-style-20260509-2320";
  const ACCORDION_VERSION = "20260509_2320";
  const MENU_ITEMS = [
  ...
  function patchAdminMenu() {
    ...
    const menuList = firstButton && (firstButton.closest(".webr-admin-menu-list") || firstButton.parentElement);
