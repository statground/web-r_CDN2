...
function set_main() {
  function PubMedWordcloudApp() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "min-h-[calc(100vh-130px)] bg-slate-50" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto flex w-full max-w-7xl flex-col gap-5 px-4 py-6 md:px-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-start justify-between gap-3" }, /*  */ React.createElement(Div_page_header, { title: "PubMed wordcloud" }), /*  */ React.createElement("span", { className: "rounded border border-slate-200 bg-white px-3 py-1 text-sm text-slate-600" }, status)), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-5 lg:grid-cols-[360px_minmax(0,1fr)]" }, /* @__PURE__ */ React.createElement("aside", { className: "space-y-4 rounded border border-slate-200 bg-white p-4" }, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-semibold text-slate-700", htmlFor: "pubmed-query" }, "\uAC80\uC0C9\uC5B4"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        id: "pubmed-query",
        value: query,
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-2" }, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-semibold text-slate-700" }, "\uB17C\uBB38 \uC218", /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        min: "1",
