const WorkshopCatalogPage = (() => {
  ...
  function SearchFilters() {
    ...
    ), label)))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-4 gap-3 lg:grid-cols-2 md:grid-cols-1" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        className: inputClass(),
        placeholder: "\uAC80\uC0C9\uC5B4",
  ...
  function ListPage() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "w-full" }, /* @__PURE__ */ React.createElement(PageHeader, null), /* @__PURE__ */ React.createElement("section", { className: "mx-auto flex w-full max-w-screen-xl flex-row items-center justify-between gap-4 px-6 pt-8 md:flex-col md:items-start" }, /* @__PURE__ */ React.createElement("p", { className: "text-xl font-normal text-gray-900" }, items.length, "\uAC1C\uC758 \uC6CC\uD06C\uC0F5\uC774 \uAC80\uC0C9\uB418\uC5C8\uC2B5\uB2C8\uB2E4."), /* @__PURE__ */ React.createElement(AdminToolbar, null)), /* @__PURE__ */ React.createElement(SearchFilters, null), /* @__PURE__ */ React.createElement("section", { className: "mx-auto w-full max-w-screen-xl px-6 py-8" }, state.error && /* @__PURE__ */ React.createElement("div", { className: "mb-5 border-y border-red-100 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700" }, state.error), items.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "border-y border-gray-200 py-12 text-center text-gray-500" }, "\uB4F1\uB85D\uB41C \uC6CC\uD06C\uC0F5\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.") : /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-4 gap-x-6 gap-y-8 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1" }, items.map((item) => /* @__PURE__ */ React.createElement(WorkshopCard, { key: item.uuid, item })))));
  }
  function FormPage() {
