...
function Div_main(props) {
  ...
  )))), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-white border border-gray-200 rounded-lg shadow" }, /* @__PURE__ */ React.createElement("div", { className: "p-4 bg-white rounded-lg md:p-8 text-center" }, /* @__PURE__ */ React.createElement(Div_sub_title, { title: "\uD398\uC774\uC9C0 \uBDF0" }), /* @__PURE__ */ React.createElement("dl", { className: "grid grid-cols-4 w-full md:grid-cols-2 gap-8 p-4 mx-auto text-gray-900 md:p-8" }, /* @__PURE__ */ React.createElement(Div_sub_card, { title: "\uCD1D \uD398\uC774\uC9C0 \uBDF0", value: data.count.val_pageview_total["0"], unit: "\uAC74" }), /* @__PURE__ */ React.createElement(
    Div_sub_card,
    {
      title: "\uC62C\uD574 \uD398\uC774\uC9C0 \uBDF0",
