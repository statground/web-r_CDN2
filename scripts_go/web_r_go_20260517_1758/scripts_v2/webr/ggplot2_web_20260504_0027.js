...
function set_main() {
  function App() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "min-h-[calc(100vh-130px)] bg-slate-50" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto flex w-full max-w-7xl flex-col gap-5 px-4 py-6 md:px-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-start justify-between gap-3" }, /*  */ React.createElement(Div_page_header, { title: "\uC6F9\uC5D0\uC11C \uD558\uB294 ggplot2" }), /*  */ React.createElement("span", { className: "rounded border border-slate-200 bg-white px-3 py-1 text-sm text-slate-600" }, status)), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-5 lg:grid-cols-[380px_minmax(0,1fr)]" }, /* @__PURE__ */ React.createElement("aside", { className: "space-y-4 rounded border border-slate-200 bg-white p-4" }, /* @__PURE__ */ React.createElement("select", { value: type, onChange: (e) => setType(e.target.value), className: "w-full rounded border-slate-300 text-sm" }, /* @__PURE__ */ React.createElement("option", { value: "scatter" }, "\uC0B0\uC810\uB3C4"), /* @__PURE__ */ React.createElement("option", { value: "bar" }, "\uB9C9\uB300\uADF8\uB798\uD504"), /* @__PURE__ */ React.createElement("option", { value: "box" }, "\uC810 \uADF8\uB798\uD504")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-2 sm:grid-cols-3" }, /* @__PURE__ */ React.createElement("input", { value: x, onChange: (e) => setX(e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { value: y, onChange: (e) => setY(e.target.value), className: "rounded border-slate-300 text-sm" }), /* @__PURE__ */ React.createElement("input", { value: g, onChange: (e) => setG(e.target.value), className: "rounded border-slate-300 text-sm" })), /* @__PURE__ */ React.createElement("textarea", { value: csv, onChange: (e) => setCsv(e.target.value), rows: 14, spellCheck: "false", className: "w-full rounded border-slate-300 font-mono text-xs leading-5" }), /* @__PURE__ */ React.createElement("button", { type: "button", disabled: busy, onClick: run, className: "w-full rounded bg-teal-700 px-4 py-2 text-sm font-semibold text-white hover:bg-teal-800 disabled:bg-slate-400" }, busy ? "\uC2E4\uD589 \uC911" : "\uADF8\uB798\uD504 \uADF8\uB9AC\uAE30"), error ? /* @__PURE__ */ React.createElement("div", { className: "whitespace-pre-wrap rounded border border-rose-200 bg-rose-50 px-3 py-2 text-sm text-rose-700" }, error) : null), /* @__PURE__ */ React.createElement("main", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("section", { className: "rounded border border-slate-200 bg-white p-4" }, /* @__PURE__ */ React.createElement("canvas", { ref: canvasRef, className: "h-[460px] w-full rounded bg-white" }))))));
  }
