...
function getCommunityHeaderTitle(boardUrl) {
    ...
    if (boardUrl === "rproject") { return "R-Project (Official)"; }
...
function DivBoardTabs() {
    ...
    return (
        <div class="flex flex-wrap items-center gap-2 w-full pt-2">
            ...
            <TabButton active={activeTab === "rproject"} onClick={() => handleChangeTab("rproject")}>R-Project (Official)</TabButton>
...
function Div_new_article_list(props) {
    ...
    const linkProps = cu === "notebook" && props.data.url
        ? { href: href, target: "_blank", rel: "noopener noreferrer" }
        : { href: href };

    return (
        <div class="bg-white w-full">
            <a {...linkProps} class="flex flex-col px-6 py-4 space-y-1 cursor-pointer hover:bg-gray-50 rounded-lg mx-3 my-2">
